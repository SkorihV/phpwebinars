...
{/if}
    <form action="" method="post">
        <div class="form-group">
            ...
            <input  name="name" {if $smarty.post.name}value="{$smarty.post.name}"{/if} type="text" class="form-control {if $error.requiredFields.name}is-invalid{/if}" id="user-name" placeholder="ФИО">
